...
const CommentsForm = ({ slug }) => {
  ...
  useEffect(() => {
    nameEl.current.vaule = window.localStorage.getItem('name');
    emailEl.current.vaule = window.localStorage.getItem('email');
  ...
  return (
    <div className='bg-white shadow-lg rounded-lg p-8 pb-12 mb-8'>
        <h3 className='text-xl mb-8 font-semibold bodrer-b pb-4'>Leave a Reply</h3>
